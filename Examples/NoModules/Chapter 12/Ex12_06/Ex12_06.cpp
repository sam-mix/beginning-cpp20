...
// and the member functions in source file. To mirror the book's exercise,
// though, here we define all members in the header as well (as inline
// functions). See online Appendix A for details.
